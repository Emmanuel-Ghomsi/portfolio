...
import CertificationTimeline from "@/components/about/certification-timeline";
import ExperienceTimeline from "@/components/about/experiences-timeline";
        ...
        <div className="container mx-auto">
          ...
          >
            <blockquote className="my-4 border-s-4 border-gray-300 bg-gray-50 p-4 dark:border-gray-500 dark:bg-gray-800">
              ...
              <p>
                Aujourd&apos;hui, je travaille sur des projets ambitieux pour
                des clients variés, en tant que développeur freelance et chef de
